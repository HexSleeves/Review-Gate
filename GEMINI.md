# Review Gate V3 - Project Context

## Project Overview

Review Gate V3 is a tool designed to enhance the workflow within the Cursor IDE. It acts as an intermediary layer (a "gate") that forces an interactive review step before the AI agent concludes a task. This allows users to provide multi-modal feedback (text, voice, images) to guide the agent iteratively within a single request context.
