  ...
  return new Promise((resolve) => {
    try {
      ...
      testProcess.on("close", (code) => {
        ...
        setTimeout(() => {
          try {
            ...
            console.error("Error killing microphone test process:", e);
          }
        }, 3000);
      });
      ...
      testProcess.on("error", (error) => {
        resolve({
          success: false,
          error: `SoX not installed: ${error.message}`,
        });
      });
      ...
      setTimeout(() => {
        try {
          ...
          console.error("Error killing SoX version check process:", e);
        }
      }, 2000);
    } catch (error) {
      resolve({
        success: false,
        error: `SoX validation error: ${error.message}`,
      });
    }
  });
}
      ...
      if (fs.existsSync(resultFile)) {
        try {
          ...
          try {
            ...
            console.error("Error cleaning up speech response file:", e);
          }
          ...
          try {
            ...
            console.error("Error cleaning up speech trigger file:", e);
          }
        } catch (error) {
